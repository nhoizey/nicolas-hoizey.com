...
lang:       fr
tags:       [jeu, Web, Responsive Web Design, SVG, esviji]
---

Voilà plus d'un an que je travaille sur une nouvelle version de mon jeu *esviji* développé en technologies Web, et plus particulièrement en SVG. Avant la sortie prochaine de cette v2 sur tous vos écrans, voici déjà un petit *teasing* de son interface devenue complètement responsive.{% cloudinary esviji2-landscape.jpg alt="esviji v2 en vue horizontale" %}
...
https://www.youtube.com/watch?v=R2rxU9cVSqw
