...
{% cloudinary wordle-delicious.png caption="Nuage de tags extrait de del.icio.us" %}


Et cet autre produit avec les tags de Gastero Prod[^2] :

{% cloudinary wordle-gasteroprod.png caption="Nuage de tags extrait de Gastero Prod" %}
...
{% cloudinary nuage-de-tags-gastero-prod.png caption="Nuage de tags de Gastero Prod" %}
