...
{% cloudinary Cuil_-_accueil.png caption="Page d'accueil de Cuil" %}
...
{% cloudinary Cuil_-_recherche_clever_age.png caption="Recherche de « clever age »" %}
...
{% cloudinary Cuil_-_Cuill.png caption="Cuil s'appelait Cuill. Premier résultat de la recherche sur « cuill » dans « cuil »" %}
