...
![](hoefler-text.jpg){caption="Un aperçu de la fonte Hoefler Text"}
...
![](fonte-avenir.jpg){caption="Un aperçu de la fonte Avenir"}
...
![](gastero-prod-win7-chrome.png){caption="Gastero Prod sur Windows 7 avec Chrome"}
