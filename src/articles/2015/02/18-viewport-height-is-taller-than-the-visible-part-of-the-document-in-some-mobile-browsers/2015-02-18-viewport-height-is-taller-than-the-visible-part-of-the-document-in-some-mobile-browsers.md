...
![](ios-safari-portrait-before-scroll.png){.onehalf caption="The page rendering in portrait mode with visible browser chrome"}

![](ios-safari-landscape-before-scroll.png){.twothirds caption="The page rendering in landscape mode with visible browser chrome"}

`100vh` is computed for when the browser interface is hidden, after a scroll :

![](ios-safari-portrait-after-scroll.png){.onehalf caption="The page rendering in portrait mode with reduced browser chrome"}

![](ios-safari-landscape-after-scroll.png){.twothirds caption="The page rendering in landscape mode with reduced browser chrome"}
...
![](firefox-os-before-scroll-r90.jpg){caption="onehalf"}
...
![](android-chrome-before-after-scroll.png){.onehalf caption="The font-size increases when the user scrolls"}
