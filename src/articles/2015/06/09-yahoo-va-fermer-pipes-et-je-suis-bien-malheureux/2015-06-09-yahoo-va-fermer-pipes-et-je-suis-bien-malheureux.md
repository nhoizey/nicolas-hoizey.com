...
{% respimg "yahoo-pipes-pinboard-twitter.png", "Vue graphique d'un *Pipe* de transformation de flux RSS", page %}
...
{% respimg "pinboard-bookmark.png", "Un bookmark dans Pinboard", page %}
