...
{% respimg "manege-carrousel.png", "onethird" %}
...
{% respimg "projecteur-diapos-carrousel.jpg", "", "onethird" %}
...
{% respimg "apple-itunes-coverflow.png", "CoverFlow. Navigation en 3D dans la discothèque iTunes" %}
...
{% respimg "caroussel-3d-amazon.png", "Le carrousel d'Amazon" %}
...
{% respimg "carroussel-3d-alapage-3.png", "Le carrousel d'Alapage" %}
