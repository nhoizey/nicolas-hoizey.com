...
![](manege-carrousel.png){caption="onethird"}
...
![](apple-itunes-coverflow.png){caption="CoverFlow. Navigation en 3D dans la discothèque iTunes"}
...
![](caroussel-3d-amazon.png){caption="Le carrousel d'Amazon"}
...
![](carroussel-3d-alapage-3.png){caption="Le carrousel d'Alapage"}
