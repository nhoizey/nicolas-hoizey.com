...
![](diigo.png){caption="L'interface de Diigo"}
...
![](pinboard.png){caption="L'interface de Pinboard"}
...
![](seenthis.png){caption="L'interface de Seenthis"}
...
![](diigo-web-performance.png){caption="Le groupe Web Performance sur Diigo"}
