...
![](itunes-listes-intelligentes.png){caption="Cinq listes intelligentes pour sélectionner la musique à écouter"}


Les intitulés sont à priori explicites, mais voici la configuration de l'une d'elles :


![](itunes-liste-intelligente-4-etoiles.png){caption="Une liste intelligente pour écouter les morceaux 4 étoiles une fois par semaine. Oui, je retire la musique pour enfants, j'ai d'autres occasions de l'écouter…"}


Rassembler ces listes dans un dossier permet de jouer l'ensemble dans iTunes en sélectionnant le dossier en question :


![](itunes-dossier-listes-intelligentes.png){caption="Un dossier pour obtenir une liste composée. C'est donc un « ou » logique."}
...
![](itunes-liste-intelligente-dossier.png){caption="Une liste intelligente pour rassembler les listes d'un dossier"}
