...
{% cloudinary extension-firefox-supportee.png caption="L'installation est possible pour une extension supportée par la version courante de Firefox" %}


{% cloudinary extension-firefox-non-supportee.png caption="Mais impossible pour une version non supportée" %}
