...
{% respimg "JPGMag-Lost_in_white_space-hot.png", "Lost in (white) space" %}

Vous voyez, au milieu de la page, ce petit badge :

{% respimg "JPGMag-this-photo-is-hot.png" %}
...
{% respimg "JPGMag-Color_Theory.png", "Le thème « Color Theory »" %}
