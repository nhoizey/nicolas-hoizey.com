...
{% respimg "gp_agenda.png", "Exemple d'agenda. L'agenda de [Gastero Prod](http://www.gasteroprod.com/agenda/)", page %}
...
{% respimg "publi_anterieure.png", "Utilisation de la date de publication antérieure", page %}
...
{% respimg "hierarchie.png", "Une hiérarchie de rubriques pour les thèmes", page %}
...
{% respimg "gp_agenda_themes.png", "Le rendu de la sélection thématique", page %}
