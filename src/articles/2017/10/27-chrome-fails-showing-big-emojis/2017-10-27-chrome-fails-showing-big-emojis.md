...
{% respimg "chrome-emoji-128px-max.png", "Chrome doesn't show emoji for a `font-size` above `128px`", page %}
...
{% respimg "chrome-emoji-65px-scale-2-either.png", "Chrome doesn't show a `65px` emoji scaled twice either", page %}
