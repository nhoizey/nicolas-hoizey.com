...
![](chrome-emoji-128px-max.png){caption="Chrome doesn't show emoji for a `font-size` above `128px`"}
...
![](chrome-emoji-65px-scale-2-either.png){caption="Chrome doesn't show a `65px` emoji scaled twice either"}
