...
![](/assets/logos/pwa.png){.logo caption="PWA"}
...
![](webpagetest-resilient-web-design.png){caption="The Resilient Web Design web book audited by WebPagetest"}
...
![](what-does-my-site-cost.png){caption="Cost of visiting this website as a percentage of daily income"}
