...
{% respimg "impact-redirection-webperf-fibre.png", "L'impact des redirections avec une connexion fibre" %}
...
{% respimg "impact-redirection-webperf-3g.png" %}
...
{% respimg "impact-redirection-webperf-3g-latence.png" %}
