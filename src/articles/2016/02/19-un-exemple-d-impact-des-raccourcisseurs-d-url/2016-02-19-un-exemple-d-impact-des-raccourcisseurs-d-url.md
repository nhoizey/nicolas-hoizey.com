...
{% respimg "impact-redirection-webperf-fibre.png", "L'impact des redirections avec une connexion fibre", page %}
...
{% respimg "impact-redirection-webperf-3g.png", page %}
...
{% respimg "impact-redirection-webperf-3g-latence.png", page %}
