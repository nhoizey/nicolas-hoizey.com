...
{% respimg "/assets/logos/jekyll.png", "Logo de Jekyll", "logo", page %}
...
{% respimg "/assets/logos/cloudinary.png", "Logo de Cloudinary", "logo", page %}
...
```markdown
{% respimg "cloudflare.png", "Un schéma montrant l'apport de Cloudflare", page %}
...
{% respimg "cloudinary-pricing.png", "Les tarifs de Cloudinary, dont l'offre gratuite déjà généreuse", page %}
...
{% respimg "dareboost-de-98-a-94.png", "4 points perdus sur Dareboost", page %}
