...
![](/assets/logos/jekyll.png){.logo caption="Logo de Jekyll"}
...
![](/assets/logos/cloudinary.png){.logo caption="Logo de Cloudinary"}
...
```markdown
![](cloudflare.png){caption="Un schéma montrant l'apport de Cloudflare"}
...
![](cloudinary-pricing.png){caption="Les tarifs de Cloudinary, dont l'offre gratuite déjà généreuse"}
...
![](dareboost-de-98-a-94.png){caption="4 points perdus sur Dareboost"}
